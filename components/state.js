...
if (typeof window !== "undefined") {
    INITIAL_STATE = { Socket: null,rooms:null,joinedroom: JSON.parse(localStorage.getItem("joinedroom"))||null,name: JSON.parse(localStorage.getItem("name"))||null,err:false, party:[] };
  }
...
,[])
return(
    <AuthContext.Provider value={{Socket:state.Socket,
    rooms:state.rooms,
    err:state.err,
    party:state.party,
