  ...
  return (
    ...
    >
      <motion.div
        ...
        className=" marcellus max-[550px]:w-[250px]  w-[200px] h-[150px] md:w-[250px] md:h-[200px] flex flex-col   rounded-sm overflow-hidden  hover:cursor-pointer mx-2 my-2 border border-gray-400 "
      >
        <div className="relative w-full h-[100px] md:w-[250px] md:h-[150px]">
          {url && <Image className=" " src={url} fill alt="alt" />}
        </div>
