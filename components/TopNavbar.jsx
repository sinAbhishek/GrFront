...
const TopNavbar = () => {
  ...
  return (
    <div
      className={` max-[480px]:${
        pathname === "/" ? "bg-[#10040b]" : "bg-transparent"
      } w-screen max-[480px]:pl-0 max-[480px]:justify-center fixed bg-transparent flex justify-start gap-8 pl-[90px] h-[80px] items-center z-10`}
    >
      <button
