    ...
    >
      ...
      <div className="max-[480px]:min-w-[100%] pl-[80px] max-[650px]:min-w-[600px] min-w-[700px] sm:w-full w-[60%] h-full flex flex-col  justify-center items-center ">
        <img
          ...
          alt=""
        />
        <h2 className="alicehead max-[480px]:text-2xl max-[900px]:text-4xl   text-5xl font-semibold text-white z-20">
          EXPERIENCE SEVEN
        </h2>
        <h4 className=" alicehead max-[480px]:text-lg text-lg md:text-xl font-semibold text-white z-20">
